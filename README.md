...
The **EIGENRAD** package is written in `C++23` and uses the following external libraries: [BLAS](https://github.com/OpenMathLib/OpenBLAS), [LAPACK](https://github.com/reference-lapack/lapack), and [GoogleTest (gtest)](https://github.com/google/googletest). The build system is implemented using [CMake](https://cmake.org/).
